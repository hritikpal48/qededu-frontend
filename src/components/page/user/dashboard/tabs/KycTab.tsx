...
type UserKyc = {
  ...
  panNumber?: string;
  aadhaarFront?: string; // image url
  aadhaarBack?: string; // image url
    ...
    <>
      ...
      {isEditMode ? (
        ...
        <form>
          ...
          <div className="border border-dashed border-gray-300 rounded-md flex items-center justify-center bg-[#F4F5F7] h-[250px] overflow-hidden"></div>
