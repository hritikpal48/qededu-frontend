...
const resources = [
  { title: "Transfer Unlisted Shares Online", link: "#", bg: "bg-[#F7F7F7]" },
  {
    title: "Off-Market Annexures of Different DPs",
    link: "#",
    bg: "bg-[#F7F7F7]",
  },
  {
    title: "How to get Client Master List (CML/CMR)",
    link: "#",
    bg: "bg-[#F7F7F7]",
  },
  { title: "FAQs on Unlisted Shares", link: "#", bg: "bg-[#F7F7F7]" },
  {
    title: "How to Buy Unlisted Shares",
    link: "#",
    bg: "bg-[#F7F7F7]",
  },
  {
    title: "PAN Number of Unlisted Companies",
    link: "#",
    bg: "bg-[#F7F7F7]",
  },
  { title: "How to Sell Unlisted Shares", link: "#", bg: "bg-[#F7F7F7]" },
  {
    title: "Unlisted Share Research & Analysis",
    link: "#",
    bg: "bg-[#F7F7F7]",
  },
  { title: "Unlisted Shares List", link: "#", bg: "bg-[#F7F7F7]" },
  {
    title: "Do's & Don'ts of Investing in Unlisted Shares",
    link: "#",
    bg: "bg-[#F7F7F7]",
  },
];
    ...
    <>
      <div className="bg-white min-h-screen px-4 md:px-10 py-12 max-w-7xl mx-auto">
        ...
        <p className="text-center text-gray-700 text-[18px] mb-12">
          ...
          unlisted shares, transfer them online, and explore pre-IPO and
          delisted share opportunities. With years of experience and deep
          knowledge of the unlisted share market, our expert team is committed
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {resources.map((item, index) => (
            <Link
              key={index}
              href={item.link}
              className={`p-6 text-[18px] rounded-md shadow hover:scale-105 transition-transform duration-200 text-center font-medium border border-[#00a63d88] flex items-center  justify-center ${item.bg}`}
            >
              {item.title}
            </Link>
          ))}
        ...
        <div className="mt-16 text-center bg-green-600 text-white py-6 px-4 rounded-md">
