  ...
  <div className="mt-10">
    ...
    <div className="bg-white p-4 border rounded-md">
      <div className="flex justify-between mb-2 text-sm text-gray-500">
        <span>Promoters</span><span>85.56%</span>
      </div>
      <div className="h-3 bg-gray-200 rounded-full mb-4">
        <div className="bg-green-500 h-3 rounded-full w-[85.56%]"></div>
      </div>
      <div className="flex justify-between mb-2 text-sm text-gray-500">
        <span>Others</span><span>14.44%</span>
      </div>
      <div className="h-3 bg-gray-200 rounded-full">
        <div className="bg-green-300 h-3 rounded-full w-[14.44%]"></div>
      </div>
    </div>
  </div>
);
...
const events = [
  { name: 'Buyback', detail: 'AV Thomas Has Announced Buyback at Rs. 17000/Share', date: '09/02/2024' },
  { name: 'Dividend', detail: 'AV Thomas Has Given Final Dividend of INR 150/share', date: '30/05/2023' },
  { name: 'Buyback', detail: 'AV Thomas Has Announced Buyback at INR 13500/Share', date: '15/09/2022' },
...
const promoters = [
  { name: 'Mr. Ajit Thomas', role: 'Executive Chairman', exp: '35 Yrs', linkedin: '#' },
  { name: 'Mr. Dilip Thomas', role: 'Executive Vice-Chairman', exp: '35 Yrs', linkedin: '#' }
];
    ...
    <div className="overflow-x-auto border rounded-md">
      <table className="min-w-full text-sm">
        <thead className="bg-gray-50 text-left">
          <tr>
            <th className="px-4 py-2 font-medium text-gray-500">Name</th>
            <th className="px-4 py-2 font-medium text-gray-500">Designation</th>
            <th className="px-4 py-2 font-medium text-gray-500">Experience</th>
            <th className="px-4 py-2 font-medium text-gray-500">LinkedIn</th>
          </tr>
        </thead>
        <tbody className="bg-white">
...
export const DownloadSection = () => (
  <div className="mt-10">
    ...
    <div className="border p-4 rounded-md bg-white flex flex-wrap gap-4 items-center">
