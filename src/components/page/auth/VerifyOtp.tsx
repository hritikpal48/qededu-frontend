...
export default function VerifyOtp() {
    ...
    const onVerifyOtpSuccess = () => {
        toast.success('Email verifyed succsfully');
        setTimeout(() => router.push('/auth/login'), 1000)
    };

    const { mutate: resendOtpMutate, isPending: resendOtpPending } = useResendOtp({ onError: onResendOtpError, onSuccess: onResendOtpSuccess });
    const { mutate: verifyOtpMutate, isPending: verifyOtpPending } = useVerifyOtp({ onError: onVerifyOtpError, onSuccess: onVerifyOtpSuccess });
