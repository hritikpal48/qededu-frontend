...
const StockTable = ({ data, page, perPage, setPage, setPerPage, totalPage, loading }: Props) => {
    return (
                                ...
                                {data.map((stock) => (
                                    <tr key={stock.name} className="hover:bg-gray-50">
                                        <td className="px-4 py-3 flex items-center gap-2">
                                            ...
                                            />
                                            <Link href={`share?id=${stock?._id}`} className="ml-2 text-sm font-medium text-dark hover:underline">
                                                {stock.name}
                                            </Link>
                                        </td>
